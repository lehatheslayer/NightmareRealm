...
public class Game {
     ...
     * Валидным движением клетки является движение игровой клетки на свободную ячейку
     * Перемещение не на соседние клетки, на блокированную клетку, перемещение по диагонали запрещены
     *
     * @param x1 - координата x первой клетки
     * @param y1 - координата y первой клетки
     * @param x2 - координата x второй клетки
